...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [8703],
  {
    ...
    38703: function (e, t, n) {
      ...
      var U = {
          plain: { color: '#F8F8F2', background: '#282A36' },
          styles: [
            {
        ...
        G = {
          plain: { background: '#2a2734', color: '#9a86fd' },
          styles: [
            {
        ...
        Z = {
          plain: { background: '#faf8f5', color: '#728fcb' },
          styles: [
            {
              types: ['comment', 'prolog', 'doctype', 'cdata', 'punctuation'],
              style: { color: '#b6ad9a' },
        ...
        q = {
          plain: { color: '#393A34', background: '#f6f8fa' },
          styles: [
            {
        ...
        W = {
          plain: { color: '#d6deeb', background: '#011627' },
          styles: [
            {
              types: ['changed'],
        ...
        Y = {
          plain: { color: '#403f53', background: '#FBFBFB' },
          styles: [
            {
              types: ['changed'],
              style: { color: 'rgb(162, 191, 252)', fontStyle: 'italic' },
        ...
        K = '#8dc891',
        V = {
          plain: { background: '#282c34', color: '#ffffff' },
          styles: [
        ...
        X = {
          plain: { color: '#f8f8f2', background: '#272822' },
          styles: [
            {
              types: ['changed'],
              style: { color: 'rgb(162, 191, 252)', fontStyle: 'italic' },
        ...
        Q = {
          plain: { color: '#bfc7d5', background: '#292d3e' },
          styles: [
            {
              types: ['comment'],
        ...
        J = {
          plain: { color: '#9EFEFF', background: '#2D2A55' },
          styles: [
        ...
        et = {
          plain: { color: '#282a2e', background: '#ffffff' },
          styles: [
        ...
        en = {
          plain: { color: '#9CDCFE', background: '#1E1E1E' },
          styles: [
        ...
        ea = {
          plain: { color: '#000000', background: '#ffffff' },
          styles: [
        ...
        er = {
          plain: { color: '#f8fafc', background: '#011627' },
          styles: [
        ...
        eo = {
          plain: { color: '#0f172a', background: '#f1f5f9' },
          styles: [
            { types: ['prolog'], style: { color: '#000080' } },
            { types: ['comment'], style: { color: '#6A9955' } },
            {
