!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '4ed6831c-fa8c-48b8-9457-a83e664a423a'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-4ed6831c-fa8c-48b8-9457-a83e664a423a'));
  } catch (e) {}
})();
('use strict');
    ...
    47482: function (e, t, r) {
          ...
          children: [
            ...
            c &&
              (0, a.jsx)('button', {
                onClick: f,
                className: (0, l.cn)(
                  'text-foreground-lighter text-foreground-light cursor-pointer transition-all opacity-0 duration-100',
      ...
      let m = i.forwardRef((e, t) => {
        ...
        return (0, a.jsx)(n.mY.Group, {
          ref: t,
          className: (0, l.cn)(
            'overflow-hidden p-1 text-foreground-light [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]: [&_[cmdk-group-heading]]:text-foreground-muted',
              ...
              (0, a.jsxs)(n.VY, {
                ...
                children: [
                  ...
                  c
                    ? (0, a.jsxs)(n.x8, {
                        className:
                          'absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary',
                        children: [
