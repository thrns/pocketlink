!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '7d3fcf79-21ce-48da-bfff-e273f08f2ede'),
      (e._sentryDebugIdIdentifier =
        'sentry-dbid-7d3fcf79-21ce-48da-bfff-e273f08f2ede'));
  } catch (e) {}
})();
('use strict');
  ...
  [3659],
  {
    23470: function (e, t, n) {
        ...
        es = (function () {
          function e(e) {
            (void 0 === e && (e = 'Atom'),
              ...
              (this.onBUOL = void 0),
              (this.name_ = e),
              (this.batchId_ = tc.inBatch ? tc.batchId : NaN));
          }
          var t = e.prototype;
          return (
            (t.onBO = function () {
            ...
            (t.reportChanged = function () {
              ((tc.inBatch && this.batchId_ === tc.batchId) ||
                ((tc.stateVersion =
                  tc.stateVersion < Number.MAX_SAFE_INTEGER
                    ? tc.stateVersion + 1
      ...
      function ec(e, t, n) {
        ...
        var r = new es(e);
        return (t !== V && tC('onBO', r, t, void 0), n !== V && tV(r, n), r);
      }
      var el = {
      ...
      function eC(e, t, n, r) {
        ...
        if (r !== e.target_ && 'function' == typeof n.value)
          return L(n.value)
            ? (null != (s = this.options_) && s.autoBind ? tK.bound : tK).make_(
                e,
                t,
                n,
                r
              )
            : (null != (a = this.options_) && a.autoBind ? tP.bound : tP).make_(
                e,
                t,
                n,
                r
      ...
      var ez = A(eq, {
          box: function (e, t) {
            var n = t || eI;
            return new e2(e, eK(n), n.name, !0, n.equals);
          },
          array: function (e, t) {
            var n = t || eI;
            return (
      ...
      var e2 = (function (e) {
        ...
        return (
          ...
          (n.prepareNewValue_ = function (e) {
            if (tX(this)) {
              var t = tJ(this, { object: this, type: t7, newValue: e });
          ...
          (n.setNewValue_ = function (e) {
            ...
            ((this.value_ = e),
              this.reportChanged(),
              t$(this) &&
                tZ(this, { type: t7, object: this, newValue: e, oldValue: t }));
          }),
          (n.get = function () {
          ...
          return (
            ...
            (t.trackAndCompute = function () {
              var e = this.value_,
                ...
                r = t || e4(e) || e4(n) || !this.equals_(e, n);
            ...
            (t.computeValue_ = function (e) {
              ...
              var t,
                n = e0(!1);
              if (e) t = e9(this, this.derivation, this.scope_);
      ...
      function t_() {
        (0 === tc.inBatch &&
          (tc.batchId =
            tc.batchId < Number.MAX_SAFE_INTEGER
              ? tc.batchId + 1
              : Number.MIN_SAFE_INTEGER),
          tc.inBatch++);
      }
          ...
          return (
            ...
            (t.runReaction_ = function () {
              if (!this.isDisposed_) {
                ...
                if (((tc.trackingContext = this), e6(this))) {
            ...
            (t.track = function (e) {
              if (!this.isDisposed_) {
                ...
                var n = e9(this, e, void 0);
                ((tc.trackingContext = t),
                  (this.isRunning_ = !1),
                  (this.isTrackPending_ = !1),
                  this.isDisposed_ && e5(this),
                  e4(n) && this.reportExceptionInDerivation_(n.cause),
                  tf());
              }
            }),
      ...
      (Object.assign(tP, tj), (tk.bound = er(tS)), (tP.bound = er(tx)));
      var tT = function (e) {
        return e();
      };
      function tV(e, t, n) {
        return tC('onBUO', e, t, n);
      }
      function tC(e, t, n, r) {
      ...
      var tU = eg('flow'),
        tG = eg('flow.bound', { bound: !0 }),
        tK = Object.assign(function (e, t) {
          ...
          var n = e.name || '<unnamed flow>',
            r = function () {
              var t,
                r = arguments,
                i = ++tB,
                o = tk(n + ' - runid: ' + i + ' - init', e).apply(this, r),
                a = void 0,
              ...
              return (
                (s.cancel = tk(n + ' - runid: ' + i + ' - cancel', function () {
                  try {
                    a && tq(a);
                    var e = o.return(void 0),
                      n = Promise.resolve(e.value);
                    (n.then(V, V), tq(n), t(new tM()));
                  } catch (e) {
                    t(e);
                  }
                })),
      ...
      function tH(e) {
        return !!e && (nb(e) || !!e[ea] || eu(e) || tm(e) || e7(e));
      }
      function tW(e, t) {
        ...
        return I(e)
          ...
          : (nk(function () {
              ...
              if (!e[t1]) {
                ...
                (o.delete('constructor'), o.delete(ea), B(i, t1, o));
              }
      ...
      function t9(e, t) {
        'function' == typeof Array.prototype[e] && (t6[e] = t(e));
      }
      function t5(e) {
        return function () {
          var t = this[ea];
      ...
      (t9('concat', t5),
        ...
        t9('reduce', nt),
        t9('reduceRight', nt));
      var nn = U('ObservableArrayAdministration', t4);
      function nr(e) {
        return D(e) && nn(e[ea]);
      }
      var ni = {},
      ...
      var na = (function () {
          ...
          return (
            ...
            (t.delete = function (e) {
              ...
              if (
                (this.keysAtom_,
                tX(this) && !tJ(this, { type: no, object: this, name: e }))
              )
                return !1;
              if (this.has_(e)) {
                var n = t$(this),
      ...
      function nx(e, t) {
        if ('object' == typeof e && null !== e) {
          ...
          if (ns(e)) {
            ...
            return (n || r(25, t, nE(e)), n);
          }
          if (nb(e)) {
            if (!t) return r(26);
            var i = e[ea].values_.get(t);
            return (i || r(27, t, nE(e)), i);
          }
          if (eu(e) || e7(e) || tm(e)) return e;
        } else if (C(e) && tm(e[ea])) return e[ea];
        r(28);
      }
      function nE(e, t) {
        var n;
        if (void 0 !== t) n = nx(e, t);
          ...
          if (tN(e)) return e.name;
          n =
            nb(e) || ns(e) || nl(e)
              ? (function e(t, n) {
                  return (t || r(29), void 0 !== n)
                    ? e(nx(t, n))
                    : eu(t) || e7(t) || tm(t) || ns(t) || nl(t)
                      ? t
                      : t[ea]
                        ? t[ea]
                        : void r(24, t);
      ...
      (Object.entries(t6).forEach(function (e) {
        var t = e[0],
          n = e[1];
        'concat' !== t && B(nw.prototype, t, n);
      }),
        nj(1e3));
      var nP = j.toString;
      function nN(e, t, n) {
