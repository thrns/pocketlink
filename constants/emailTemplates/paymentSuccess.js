...
<head>
  ...
  <title>Payment Confirmed - PocketLink</title>
  <style>
    body {
      ...
      <tr>
        <td class="padding">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0" class="hello-section">
            <tr>
              <td class="message success-accent">
                <p>Hi {{userName}} 👋</p>
                <p>Great news! Your {{paymentType}} payment has been processed successfully.</p>
                ...
                <div class="receipt-section">
                  ...
                  <table class="receipt-table" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                      ...
                      <td class="receipt-value">{{paymentDate}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="receipt-value"><span class="status-badge">PAID</span></td>
                    </tr>
                    <tr>
                      <td colspan="2">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0" class="next-steps-section">
            <tr>
              <td class="section-title">What's Next? 🚀</td>
            </tr>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      ...
                      <td class="step-content">
                        <p class="step-title">Your account is now {{subscriptionStatus}}</p>
                        <p class="step-description">All your premium features are ready to use</p>
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <div class="step">
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      ...
                      <td class="step-content">
                        <p class="step-title">Explore your premium features</p>
                        <p class="step-description">Custom domains, advanced analytics, premium themes & more</p>
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <div class="step">
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      ...
                      <td class="step-content">
                        <p class="step-title">View your billing details</p>
                        <p class="step-description">Manage subscriptions and download invoices anytime</p>
                      </td>
                    </tr>
                  </table>
                </div>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td>
                <div class="tips-box">
                  <p class="tips-title"><span class="tips-icon">💡</span>Getting the Most from Premium</p>
                  <p><strong>Set up custom domain:</strong> Make your page more professional with your own domain</p>
                  <p><strong>Check analytics:</strong> See detailed insights about your visitors and clicks</p>
                  <p><strong>Customize themes:</strong> Access exclusive designs and advanced customization</p>
                  <p><strong>Enable AI features:</strong> Use our AI chatbot and content suggestions</p>
                </div>
              </td>
            </tr>
          </table>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td class="message info-accent">
                ...
                <p>Our support team is here to help you make the most of your premium features. Feel free to reach out with any questions!</p>
                <p>You can also check out our help center for tutorials and guides.</p>
              </td>
            </tr>
          </table>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td style="padding: 20px 0; color: #555555; font-size: 14px; text-align: center;">
                Questions about your account? Contact us: <a href="mailto:support@pocketlink.co" style="color: #8B5CF6; text-decoration: none;">support@pocketlink.co</a>
              </td>
            </tr>
          </table>
        </td>
