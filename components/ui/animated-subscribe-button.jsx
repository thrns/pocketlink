      ...
      <AnimatePresence mode="wait">
        {isSubscribed ? (
          <motion.button
            ref={ref}
            className={cn(
              'relative flex h-10 w-fit items-center justify-center overflow-hidden rounded-lg bg-zinc-900 px-6 text-zinc-50 dark:bg-zinc-50 dark:text-zinc-900',
              className
            )}
            onClick={(e) => {
          ...
          <motion.button
            ref={ref}
            className={cn(
              'relative flex h-10 w-fit cursor-pointer items-center justify-center rounded-lg border-none bg-zinc-900 px-6 text-zinc-50 dark:bg-zinc-50 dark:text-zinc-900',
              className
            )}
            onClick={(e) => {
