  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex',
        head_cell:
          'text-zinc-500 rounded-md w-8  text-[0.8rem] dark:text-zinc-400',
        ...
        day_selected:
          'bg-zinc-900 text-zinc-50 bg-zinc-900 text-zinc-50 focus:bg-zinc-900 focus:text-zinc-50 dark:bg-zinc-50 dark:text-zinc-900 dark:bg-zinc-50 dark:text-zinc-900 dark:focus:bg-zinc-50 dark:focus:text-zinc-900',
        day_today:
