...
export default function UrlVertical({
  cardVariants,
  itemId,
  card,
  isEditing,
  ...
  // Get text color with proper priority: cardContent.cardThemeBright first, then themeData.textMode if it doesn't exist
  const getTextColor = () => {
      ...
      <div className="relative z-10 mb-2 flex w-full flex-col items-start justify-start">
        ...
        {isEditing ? (
          <Input
            ...
            onMouseDown={(e) => e.stopPropagation()}
            className="cursor-pointer border-none bg-gray-200 bg-transparent text-[14px] font-medium shadow-none focus:cursor-text focus:border-none focus:bg-gray-200 focus:ring-0 dark:bg-gray-800 focus:dark:bg-gray-800"
            style={{
        ...
        {isEditing ? (
          <Input
            ...
            onMouseDown={(e) => e.stopPropagation()}
            className="mt-1 cursor-pointer border-none bg-gray-200 bg-transparent text-[12px] font-medium shadow-none focus:cursor-text focus:border-none focus:bg-gray-200 focus:ring-0 dark:bg-gray-800 focus:dark:bg-gray-800"
            style={{
              background: 'transparent',
              border: 'none',
              outline: 'none',
        ...
        {shouldHavePreview ? (
          isPreviewLoading ? (
            ...
            <img
              ...
              alt="Preview"
              className="max-h-[300px] w-full rounded-md object-cover object-top"
            />
          ) : (
