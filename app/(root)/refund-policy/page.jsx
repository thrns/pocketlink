    ...
    <>
      <Container className="w-full py-40">
        ...
        <div className="prose dark:prose-invert">
          <p className="mb-4">Last Updated: April 4, 2023</p>

          <h2 className="mb-3 mt-6 text-xl font-semibold">Overview</h2>
          <p>
            Pocketlink (a product of Astrapi Money Pvt Ltd) is committed to
            providing a high-quality service. This Refund and Cancellation
            Policy outlines the terms and conditions regarding subscription
          ...
          <ul className="my-3 list-disc pl-6">
            ...
            <li>
              ...
              unauthorized charges from Pocketlink on your account, please
          ...
          <ul className="my-3 list-disc pl-6">
            ...
            <li>
              For payments made through Razorpay, refunds typically process
          ...
          <div className="mt-3">
            <p>
              <strong>Astrapi Money Pvt Ltd</strong> (makers of Pocketlink)
            </p>
            <p>
              Sf No 61/2 7a1/a2,b Bl 1c, Kaveri Ngr,velapanchavadi, Ayapakkam,
              Tiruvallur, Poonamallee, Tamil Nadu, India, 600077
            </p>
            <p>
              Email:{' '}
              <a
